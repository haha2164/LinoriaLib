...
local TextService = cloneref(game:FindService('TextService'));
local Teams = cloneref(game:FindService('Teams'));
...
local ScreenGui = Instance.new('ScreenGui', gethui and gethui() or cloneref(game:FindService('CoreGui'))); do
